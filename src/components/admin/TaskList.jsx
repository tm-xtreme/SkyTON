            ...
            {tasks.length > 0 ? tasks.map((task) => (
              <TableRow key={task.id}>
                ...
                <TableCell className="text-right space-x-1">
                  <Button variant="outline" size="icon" className="h-8 w-8" onClick={() => onEditClick(task)} disabled={isEditing}>
               ...
               <TableRow>
                 <TableCell colSpan={6} className="text-center text-muted-foreground">No tasks created yet.</TableCell>
               </TableRow>
            )}
          </TableBody>
        </Table>
